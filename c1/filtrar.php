      ...
      <div class="card card-panel center bgAlfabetizacion white-text hoverable">
        <div class="row">
          <div class="col s12 m10 l0"><br>
            <p><b style="font-size: 20px;">Filtra información y contenidos digitales desde diferentes dispositivos a través de servicios en línea.</b></p>
          </div>
    ...
    <div class="card card-panel">
      <div class="row">
        ...
        <ul class="collapsible">
          ...
          <li>
            <div class="collapsible-header hover_item"><i class="material-icons blue-text tyni">menu_book</i>1.) Modelo gavilanes y modelo Big6.</div>
          ...
          <li>
            <div class="collapsible-header hover_item"><i class="material-icons blue-text tyni">menu_book</i>2.) Curación de contenidos.</div>
            <div class="collapsible-body">
              <div class="row">
                <div class="col s12 m4 l4">
                  <ul>
          ...
          <li>
            <div class="collapsible-header hover_item"><i class="material-icons blue-text tyni">menu_book</i>3.) Marcadores sociales.</div>
            <div class="collapsible-body">
              <div class="row">
                <div class="col s12 m4 l4">
                  <ul>
      ...
      <div class="row">
        <a class="waves-effect waves-red btn-large right" href="glosario.php">Revisar glosario<i class="material-icons right white-text">last_page</i></a>
      </div>
